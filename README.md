> **Fork modernisé** — Ce dépôt est une mise à jour de [eDEX-UI](https://github.com/GitSquared/edex-ui) v2.2.8 vers **Electron 32 / Node 20** avec des améliorations de sécurité et de stabilité.
> 
> Tout le crédit revient à **Gabriel 'Squared' SAILLARD** ([@GitSquared](https://github.com/GitSquared)) et aux contributeurs du projet original. Ce fork ne fait que prolonger la maintenance technique.
